        ...
        <Row>
          <Col md={6} className="kolom">
            ...
            <div className="bg-kolom">
              ...
              <Button type="submit" value="Send" id="submit" required>
                Submit
              </Button>
              <svg
            ...
            <Link to="/profile-web">
              <Button className="button-me kanan">Back</Button>
            </Link>
          </Col>
        </Row>
      </Container>
...
export default ContactDuplikat;
